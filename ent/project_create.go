...
func (_c *ProjectCreate) SetOwnerUserID(v string) *ProjectCreate {
	_c.mutation.SetOwnerUserID(v)
	return _c
}

// SetContractID sets the "contract_id" field.
func (_c *ProjectCreate) SetContractID(v string) *ProjectCreate {
...
func (_c *ProjectCreate) check() error {
	...
	if _, ok := _c.mutation.ContractID(); !ok {
		return &ValidationError{Name: "contract_id", err: errors.New(`ent: missing required field "Project.contract_id"`)}
	}
