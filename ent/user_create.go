...
func (_c *UserCreate) SetBalance(v uint64) *UserCreate {
...
func (_c *UserCreate) SetOauthSub(v string) *UserCreate {
	_c.mutation.SetOauthSub(v)
	return _c
}

// SetNillableOauthSub sets the "oauth_sub" field if the given value is not nil.
func (_c *UserCreate) SetNillableOauthSub(v *string) *UserCreate {
	if v != nil {
		_c.SetOauthSub(*v)
	}
	return _c
