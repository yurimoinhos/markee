...
import (
	...
	httpapi "github.com/aggi-tech/aggipay/internal/modules/auth/interfaces/http"
	"github.com/aggi-tech/aggipay/internal/platform/config"
	"github.com/aggi-tech/aggipay/internal/platform/router"
...
func NewModule(client *ent.Client, cfg *config.Config) *Module {
	...
	useCase := application.NewUseCase(repo, jwtProvider, oidcProvider)
