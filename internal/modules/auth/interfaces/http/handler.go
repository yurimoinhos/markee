...
import (
	...
	"github.com/aggi-tech/aggipay/internal/modules/auth/application"
...
type registerRequest struct {
	...
	PhoneNumber string `json:"phoneNumber" example:"11999999999" asn1:"optional"`
	Password    string `json:"password"    example:"minha-senha-segura-123"`
}
...
//	@Description	Cria um novo usuário com email e senha (login local). Valida política NIST 800-63B.
//	@Tags			Auth
//	@Accept			json
//	@Produce		json
...
func (h *Handler) ListUsers(c *gin.Context) {
	...
	users, err := h.useCase.ListUsers(c.Request.Context(), page, pageSize)
	if err != nil {
		_ = c.Error(err)
		return
	}
